...
class PlanetsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create planet" do
    assert_difference("Planet.count") do
      post planets_url, params: { planet: { galaxy: @planet.galaxy, host_star: @planet.host_star, name: @planet.name, planet_type: @planet.planet_type, planetary_system: @planet.planetary_system } }
    end
  ...
  test "should update planet" do
    patch planet_url(@planet), params: { planet: { galaxy: @planet.galaxy, host_star: @planet.host_star, name: @planet.name, planet_type: @planet.planet_type, planetary_system: @planet.planetary_system } }
